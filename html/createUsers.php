...
include("../configs/functions.php");
    ...
    if ( !empty($_POST)) {
        ...
        $database->query("INSERT INTO `user`(`IdUser`,`Name`, `Email`, `Created`, `Address`, `Phone`, `ImagesDefaultTime`, `Password`, `UserKey`, `isAdmin`)
                          VALUES (NULL,:Name,:Email,:Created,:Address,:Phone,:ImagesDefaultTime,:Password,:UserKey,:isAdmin)");
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="createUsers.php?id=<?php echo $id?>" method="post">
